...
function spinnerInfo(){
        ...
        "For my fourth project I built a user interface using HTML, and populated it with data from a JavaScript object containing info from some of Wes Anderson's             films. " +
